...
public struct VInt3
{
    ...
    public Vector3 vec3
    {
        get
        {
			return new Vector3((float)this.x * PrecisionFactor, (float)this.y * PrecisionFactor, (float)this.z * PrecisionFactor);
        }
    }
    ...
    public float worldMagnitude
    {
        get
        {
			...
			return (float)Math.Sqrt(num * num + num2 * num2 + num3 * num3) * PrecisionFactor;
        }
    }
    ...
    public float safeSqrMagnitude
    {
        get
        {
			float num = (float)this.x * PrecisionFactor;
            float num2 = (float)this.y * PrecisionFactor;
            float num3 = (float)this.z * PrecisionFactor;
            return num * num + num2 * num2 + num3 * num3;
        }
    }
	...
	public string ToStringF3()
	{
		return "(" + vec3.x.ToString ("f3") + ", " + vec3.z.ToString ("f3") + ")";
	}
    ...
    {
		return new Vector3((float)ob.x * PrecisionFactor, (float)ob.y * PrecisionFactor, (float)ob.z * PrecisionFactor);
    }
	...
	{
		lhs.x = (int)Math.Round((double)((float)lhs.x * rhs.scalar));
		lhs.y = (int)Math.Round((double)((float)lhs.y * rhs.scalar));
		lhs.z = (int)Math.Round((double)((float)lhs.z * rhs.scalar));
		return lhs;
	}
